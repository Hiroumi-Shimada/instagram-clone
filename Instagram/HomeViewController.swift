...
//  Instagram
//
//  Created by Hiroumi Shimada on 2020/09/22.
...
class HomeViewController: UIViewController, UITableViewDataSource, UITableViewDelegate  {
    ...
    @objc func commenthandleButton(_ sender: UIButton, forEvent event: UIEvent) {
        ...
        // 配列からタップされたインデックスのデータを取り出す
        let postData = postArray[indexPath!.row]
        let nextVC = self.storyboard?.instantiateViewController(withIdentifier: "toComment") as! commentViewController
        nextVC.recievePostdata = postData
        var commentText = ""
